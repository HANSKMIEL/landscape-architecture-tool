...
class PRInfo:
    ...
    def is_security_update(self) -> bool:
        ...
        return (any(indicator in title_lower for indicator in security_indicators) or
                any(indicator in label.lower() for label in self.labels for indicator in security_indicators))
...
class PRAnalyzer:
    ...
    def __init__(self, github_token: str | None = None, 
        ...
        self.critical_dependencies = [
            ...
            "sqlalchemy", "alembic", "gunicorn", "redis", "psycopg2"
        ]
    ...
    def generate_validation_report(self, 
        ...
        report = {
            ...
            "repository_status": "functional" if all(
    ...
    def _generate_next_steps(self, pr_counts: dict[str, Any]) -> list[str]:
        ...
        if dependabot_data["major_updates_requiring_testing"] > 0:
            ...
            steps.append(f"Extensive testing needed for {dependabot_data['major_updates_requiring_testing']} major updates: {major_prs}")
...
def create_validation_report(backend_status: str = "unknown",
                           frontend_status: str = "unknown",
                           database_status: str = "unknown", 
                           security_status: str = "unknown",
