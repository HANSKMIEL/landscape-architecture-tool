...
<<<<<<< HEAD:archive/packages/v1.00D/backend/services/vectorworks_integration.py
=======

>>>>>>> origin/main:packages/v1.00D/backend/services/vectorworks_integration.py
        ...
        return {
            ...
            "objects": [
                ...
                },
                {
                    ...
                    "layer": "Planting Plan",
                    "class": "Shrubs",
                    "data": {"quantity": "25", "size": "30-40cm", "supplier": "Hedge Specialists"},
                },
            ],
        }
<<<<<<< HEAD:archive/packages/v1.00D/backend/services/vectorworks_integration.py
...
=======
        ...
        script_lines.extend(["END;", "", "RUN(PlacePlants);"])
