        ...
        try:
            ...
            for job_name, job_config in jobs.items():
                ...
                for step in steps:
                    ...
                    if any(
                        term in step_name.lower() or term in step_run.lower()
                        for term in ["vps", "deploy", "ssh", "72.60.176.200"]
                    ):
                        analysis["vps_related"] = True
                        analysis["deployment_steps"].append({"job": job_name, "step": step_name, "type": "deployment"})
            ...
            return {"name": workflow_file.name, "error": str(e), "analysis_failed": True}
