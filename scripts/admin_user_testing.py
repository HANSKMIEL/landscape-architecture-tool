...
class AdminUserTester:
    ...
    def run_comprehensive_test(self):
        ...
        crud_passes = sum(1 for result in self.test_results["crud_tests"].values() 
        ...
        auth_passes = sum(1 for result in self.test_results["auth_tests"].values()
        ...
        # Save report
        report_file = Path(__file__).parent.parent / "reports" / f"admin_user_testing_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
