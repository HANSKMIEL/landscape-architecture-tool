...
from src.models.landscape import Project, Plant, ProjectPlant
...
class ProjectPlantService:
    ...
    def add_plant_to_project(self, project_id: int, plant_id: int, 
                           quantity: int, unit_cost: float = None,
                           notes: str = None) -> ProjectPlant:
        ...
        try:
            ...
            logger.info(f"Added plant {plant_id} to project {project_id} with quantity {quantity}")
    ...
    def update_plant_quantity(self, project_id: int, plant_id: int, 
                            new_quantity: int) -> ProjectPlant:
        ...
        try:
            ...
            logger.info(f"Updated plant {plant_id} quantity to {new_quantity} in project {project_id}")
            return project_plant
    ...
    def update_plant_status(self, project_id: int, plant_id: int, 
                          status: str) -> ProjectPlant:
    ...
    def get_project_plant_list(self, project_id: int) -> List[Dict]:
        ...
        try:
            ...
            project_plants = ProjectPlant.query.filter_by(
                project_id=project_id
            ).all()
    ...
    def update_plant_cost(self, project_id: int, plant_id: int, unit_cost: float) -> ProjectPlant:
        ...
        try:
            ...
            logger.info(f"Updated plant {plant_id} unit cost to {unit_cost} in project {project_id}")
            return project_plant
