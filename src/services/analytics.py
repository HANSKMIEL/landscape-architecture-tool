...
from src.models.landscape import Project, Plant, Client, ProjectPlant, PlantRecommendationRequest
...
class AnalyticsService:
    ...
    def get_plant_usage_analytics(self, date_range: Optional[tuple] = None) -> Dict:
        ...
        try:
            ...
            return {'error': str(e), 'most_used_plants': [], 'category_distribution': [], 'usage_trends': []}
    ...
    def get_financial_reporting(self, date_range: tuple) -> Dict:
        ...
        try:
            ...
            cost_analysis = (
                db.session.query(
                    func.sum(ProjectPlant.quantity * ProjectPlant.unit_cost).label('total_plant_costs')
                )
                .join(Project)
                .filter(*date_filter)
            ...
            return {
                'revenue_summary': {
                    ...
                    'avg_project_value': float(revenue_stats.avg_project_value) if revenue_stats.avg_project_value else 0
                },
                'revenue_trends': revenue_trends,
                'cost_analysis': {
                    'total_plant_costs': float(cost_analysis.total_plant_costs) if cost_analysis.total_plant_costs else 0
                },
    ...
    def get_recommendation_effectiveness(self) -> Dict:
        ...
        try:
            ...
            requests_with_feedback = (
                PlantRecommendationRequest.query
