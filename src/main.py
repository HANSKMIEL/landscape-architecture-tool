...
from src.models.landscape import Supplier, Plant, Product, Client, Project

# Import services
from src.services import (
    SupplierService, PlantService, ProductService, 
    ClientService, ProjectService, DashboardService
)

# Import schemas
from src.schemas import (
    SupplierCreateSchema, SupplierUpdateSchema,
    PlantCreateSchema, PlantUpdateSchema,
...
# Import utilities
from src.utils.error_handlers import register_error_handlers, handle_errors
...
def create_app():
    ...
    def get_suppliers():
        ...
        return jsonify(result['suppliers'] if 'suppliers' in result else result['items'])
