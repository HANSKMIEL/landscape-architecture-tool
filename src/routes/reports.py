...
def generate_business_summary_pdf(data):
    ...
    try:
        ...
        if data["top_clients"]:
            ...
            client_table = Table(
                client_data, colWidths=[1.5 * inch, 1.5 * inch, 1 * inch, 1.5 * inch]
            )
...
def generate_project_report_pdf(data):
    ...
    try:
        ...
        if data["plants"]:
            ...
            plant_table = Table(
                plant_data,
                colWidths=[1.5 * inch, 1.5 * inch, 1 * inch, 0.8 * inch, 0.8 * inch],
            )
            plant_table.setStyle(
                TableStyle(
                    [
        ...
        if data["products"]:
            ...
            product_table = Table(
                product_data, colWidths=[2 * inch, 1.2 * inch, 1 * inch, 1.3 * inch]
            )
