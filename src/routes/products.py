        ...
        for index, row in df.iterrows():
            try:
                ...
                product = Product(
                    ...
                    description=str(product_data.get('description', '')) if product_data.get('description') and not pd.isna(product_data.get('description')) else None,
                    category=str(product_data.get('category', '')) if product_data.get('category') and not pd.isna(product_data.get('category')) else None,
                    price=float(product_data['price']) if product_data.get('price') and not pd.isna(product_data['price']) else None,
                    unit=str(product_data.get('unit', '')) if product_data.get('unit') and not pd.isna(product_data.get('unit')) else None,
                    sku=str(product_data.get('sku', '')) if product_data.get('sku') and not pd.isna(product_data.get('sku')) else None,
