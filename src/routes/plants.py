    ...
    try:
        ...
        try:
            ...
            response = client.chat.completions.create(
                model="gpt-3.5-turbo",
                messages=[
                    {"role": "system", "content": "You are an expert landscape architect specializing in Dutch gardens and sustainable plant selection."},
            ...
            for plant in available_plants:
                ...
                if any(keyword in plant.name.lower() or keyword in plant.scientific_name.lower() 
