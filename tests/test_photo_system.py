...
class TestPhotoUpload:
    ...
    def test_upload_success(self, auth_client, app):
        ...
        response = auth_client.post('/api/photos/upload', data={
            'file': (img_data, 'test.jpg'),
            'category': 'example',
            'title': 'Test Photo',
...
class TestPhotoAPI:
    ...
    def test_get_photos_with_data(self, auth_client, app):
        ...
        img_data = create_test_image()
        upload_response = auth_client.post('/api/photos/upload', data={
            'file': (img_data, 'test.jpg'),
            'category': 'example',
            'title': 'Test Photo'
        })
    ...
    def test_get_photos_by_category(self, auth_client):
        ...
        auth_client.post('/api/photos/upload', data={
            'file': (img_data1, 'plant.jpg'),
            'category': 'plant',
            'title': 'Plant Photo'
        })
...
class TestPhotoService:
    ...
    def test_photo_service_initialization(self, app):
        ...
        with app.app_context():
            ...
            assert service.ALLOWED_EXTENSIONS == {'png', 'jpg', 'jpeg', 'gif', 'webp'}
