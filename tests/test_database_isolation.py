...
class TestDatabaseIsolation:
    ...
    def test_create_plant_isolated_2(self, app_context):
    ...
    def test_database_isolation_verification(self, app_context):
    ...
    def test_session_cleanup_after_error(self, app_context):
