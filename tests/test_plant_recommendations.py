...
class TestPlantRecommendationEngine:
    ...
    def test_feedback_saving(self, app, db_setup):
        ...
        with app.app_context():
            ...
            updated_request = PlantRecommendationRequest.query.get(logged_request.id)
...
class TestRecommendationIntegration:
    ...
    def test_full_workflow(self, client, app, db_setup):
        ...
        with app.app_context():
            ...
            request_record = PlantRecommendationRequest.query.get(rec_data['request_id'])
