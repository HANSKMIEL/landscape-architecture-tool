...
class TestPlantRoutes(DatabaseTestMixin):
    ...
    def test_get_plants_combined_filters(self, client, app_context, plant_factory):
        ...
        plant1 = plant_factory(name="Native Oak", category="Tree", native=True, sun_exposure="full_sun")
        plant2 = plant_factory(name="Import Rose", category="Shrub", native=False, sun_exposure="full_sun")
        plant3 = plant_factory(name="Native Pine", category="Tree", native=True, sun_exposure="partial_shade")
    ...
    def test_create_plant_missing_required_fields(self, client, app_context):
        ...
        plant_data = {
            "common_name": "Missing Name Plant"
        }
    ...
    def test_update_plant_success(self, client, app_context, sample_plant):
        ...
        response = client.put(f"/api/plants/{sample_plant.id}",
    ...
    def test_update_plant_not_found(self, client, app_context):
        ...
        response = client.put("/api/plants/999",
                            data=json.dumps(update_data),
                            content_type='application/json')
    ...
    def test_update_plant_invalid_data(self, client, app_context, sample_plant):
        ...
        update_data = {
            "height_min": 200.0,
            "height_max": 100.0  # Invalid: max < min
        }
    ...
    def test_delete_plant_with_project_associations(self, client, app_context, sample_plant, project_factory, client_factory):
    ...
    def test_plants_bulk_import(self, client, app_context, sample_supplier):
        ...
        response = client.post("/api/plants/bulk-import",
...
class TestPlantRoutesIntegration(DatabaseTestMixin):
    ...
    def test_full_plant_api_workflow(self, client, app_context, supplier_factory):
        ...
        response = client.put(f"/api/plants/{plant_id}",
                            data=json.dumps(update_data),
                            content_type='application/json')
        assert response.status_code == 200
    ...
    def test_plant_filtering_combinations(self, client, app_context, plant_factory):
        ...
        plants = [
            ...
            plant_factory(name="Import Rose", category="Shrub", native=False, sun_exposure="full_sun"),
            plant_factory(name="Native Pine", category="Tree", native=True, sun_exposure="partial_shade"),
            plant_factory(name="Shade Fern", category="Perennial", native=True, sun_exposure="full_shade"),
        ]
