...
class TestSupplierRoutes(DatabaseTestMixin):
    ...
    def test_get_suppliers_with_search(self, client, app_context, supplier_factory):
        ...
        supplier1 = supplier_factory(name="Alpha Nursery", contact_person="John Alpha")  # noqa: F841  # noqa: F841
    ...
    def test_get_supplier_products(self, client, app_context, sample_supplier, product_factory):
        ...
        product1 = product_factory(supplier=sample_supplier, name="Product 1")  # noqa: F841  # noqa: F841
        product2 = product_factory(supplier=sample_supplier, name="Product 2")  # noqa: F841  # noqa: F841
        other_supplier = product_factory().supplier
        product3 = product_factory(supplier=other_supplier, name="Product 3")  # noqa: F841  # noqa: F841
    ...
    def test_search_suppliers_by_specialization(self, client, app_context, supplier_factory):
        ...
        supplier3 = supplier_factory(specialization="Native Plants and Trees")  # noqa: F841  # noqa: F841
...
class TestSupplierRoutesIntegration(DatabaseTestMixin):
    ...
    def test_supplier_product_plant_management(
        ...
        plants = [plant_factory(supplier=supplier, name=f"Plant {i}") for i in range(2)]  # noqa: F841  # noqa: F841
