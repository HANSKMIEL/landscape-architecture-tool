...
class TestPlantRecommendationErrorHandling:
    ...
    def test_criteria_options_success(self, client, app, db_setup):
        ...
        with app.app_context():
            ...
            expected_fields = [
                ...
                "plant_categories", "bloom_colors", "foliage_colors", 
                "bloom_seasons", "project_types"
            ]
    ...
    def test_feedback_database_error(self, client, app, db_setup):
        ...
        with app.app_context():
            with patch('src.routes.plant_recommendations.recommendation_engine.save_user_feedback') as mock_save:
