...
class TestPRInfo:
    ...
    def test_update_type_detection(self):
        ...
        pr_minor = PRInfo(
            number=2,
            title="bump package from 1.0.0 to 1.1.0",
            state="open",
            labels=[],
            created_at="",
            updated_at="",
        ...
        pr_major = PRInfo(
            number=3,
            title="bump package from 1.0.0 to 2.0.0",
            state="open",
            labels=[],
            created_at="",
            updated_at="",
    ...
    def test_security_update_detection(self):
        ...
        pr_security = PRInfo(
            number=1,
            title="bump package from 1.0.0 to 1.0.1 (security)",
            state="open",
            labels=[],
            created_at="",
            updated_at="",
...
class TestPRAnalyzer:
    ...
    def test_categorize_dependabot_prs(self):
        ...
        prs = [
            ...
            # Critical dependency
            PRInfo(
                2, "bump flask from 2.0.0 to 2.0.1", "open", ["dependencies"], "", "", "dependabot[bot]", False, "clean"
            ),
            # Major update
            PRInfo(
                3,
            ...
            # Security patch
            PRInfo(
                4, "bump package from 1.0.0 to 1.0.1", "open", ["security"], "", "", "dependabot[bot]", False, "clean"
            ),
            # Non-dependabot PR
    ...
    def test_generate_validation_report(self, mock_counts):
        ...
        mock_counts.return_value = {
            ...
            "pr_numbers": {"safe_auto_merge": [1, 2], "manual_review": [3], "major_updates": []},
        }
...
class TestConvenienceFunction:
    ...
    def test_create_validation_report(self, mock_analyzer_class):
        ...
        # Test function call
        report = create_validation_report(backend_status="passed", frontend_status="passed")
    ...
    def test_end_to_end_scenario(self):
        ...
        test_prs = [
            ...
            PRInfo(
                ...
                "open",
                ["dependencies", "auto-merge-candidate"],
                "",
                "",
                "dependabot[bot]",
                False,
            ...
            PRInfo(
                403,
                "bump babel-jest from 30.0.5 to 30.1.2",
                "open",
                ["dependencies", "auto-merge-candidate"],
                "",
                "",
            ...
            PRInfo(
                442,
                "bump openai from 1.98.0 to 1.106.1",
                "open",
                ["dependencies", "auto-merge-candidate"],
                "",
                "",
            ...
            PRInfo(
                441,
                "bump faker from 19.6.0 to 37.6.0",
                "open",
                ["dependencies", "auto-merge-candidate"],
                "",
                "",
            ...
            # Non-dependabot PR
            PRInfo(444, "Configure Dependabot auto-merge", "open", ["enhancement"], "", "", "Copilot", False, "clean"),
        ]
