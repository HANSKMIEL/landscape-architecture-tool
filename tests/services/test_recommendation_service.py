...
class TestRecommendationService:
    ...
    def test_height_range_matching(self, recommendation_service, app_context):
        ...
        db.session.add_all([tall_plant, short_plant, medium_plant])
        db.session.commit()
    ...
    def test_empty_criteria_handling(self, recommendation_service, test_plants):
        ...
        assert "Perfect Rose" in shrub_names or "Good Lavender" in shrub_names, f"Expected shrubs not found in {shrub_names}"
