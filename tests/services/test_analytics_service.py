...
class TestAnalyticsService(DatabaseTestMixin):
    ...
    def test_get_plant_usage_analytics_with_date_range(
        self, app_context, plant_factory, project_factory, client_factory
    ):
    ...
    def test_get_project_performance_analytics_with_data(
        ...
        projects = [
            ...
            project_factory(client=client, status="planning", budget=3000.0),
        ]
    ...
    def test_get_seasonal_analytics_with_data(
        ...
        summer_project = project_factory(
            client=client, created_at=datetime(now.year, 7, 15)  # July
        )
